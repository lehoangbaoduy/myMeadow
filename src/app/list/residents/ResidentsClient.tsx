      ...
      {deactivatingTenant && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white dark:bg-darkCard rounded-xl border border-meadowBorder dark:border-darkBorder p-6 w-full max-w-md shadow-2xl">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Deactivate — {deactivatingTenant.name}</h2>
              <button onClick={() => setDeactivatingTenant(null)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-xl font-bold">&times;</button>
            </div>
            <p className="text-xs text-gray-400 mb-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                <button onClick={handleConfirmDeactivate} disabled={togglingId === deactivatingTenant.id || !deactivationDate}
                  className="flex-1 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md text-sm font-medium transition-colors disabled:opacity-50">
